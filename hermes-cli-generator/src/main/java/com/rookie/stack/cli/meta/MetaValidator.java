...
import com.rookie.stack.cli.meta.enums.FileGenerateTypeEnum;
import com.rookie.stack.cli.meta.enums.FileTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "jaguarliu");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.rookie.stack");
